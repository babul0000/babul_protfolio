...
const skills = [
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-[#61dafb] group-hover:scale-110 transition-transform duration-300" viewBox="-11.5 -10.23174 23 20.46348" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-themeText group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-[#3178c6] group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-[#f7df1e] group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-[#339933] group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-themeText group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-[#47a248] group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-[#38bdf8] group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-cyan-400 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-red-500 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-orange-500 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "HTML5 & CSS3",
    tag: "Core Semantic Web",
    color: "#e34f26",
    glow: "rgba(227, 79, 38, 0.25)",
    icon: (
      <svg className="w-10 h-10 text-[#e34f26] group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-[#007acc] group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
...
export default function Skills() {
  ...
  return (
    <section id="skills" className="section-padding bg-themeBg border-b border-themeBorder relative font-sans antialiased text-themeText" ref={ref}>
      ...
      <div className="absolute bottom-[20%] right-[-10%] w-[350px] h-[350px] bg-cyan-500/5 rounded-full blur-[90px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 reveal">
          ...
          <p className="text-themeTextMuted text-sm mt-3 max-w-md mx-auto font-normal">
            Core frameworks, databases, and development tools I work with to build robust web applications.
          </p>
        </div>

        {/* All Skills Unified in One Icon Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4 md:gap-5">
          {skills.map((skill, idx) => (
            <div
              key={skill.name}
              className="bg-themeCard/90 border border-themeBorder rounded-3xl p-5 flex flex-col items-center justify-center gap-3 text-center transition-all duration-300 hover:scale-105 hover:border-themeAccent/40 group relative overflow-hidden shadow-sm reveal cursor-default backdrop-blur-sm"
              style={{ transitionDelay: `${0.03 * (idx + 1)}s` }}
            >
              {/* Dynamic Glow Mesh matching the skill's official color */}
              <div
                className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-3xl"
                style={{
                  background: `radial-gradient(circle at 50% 40%, ${skill.glow} 0%, transparent 70%)`
                }}
              />

              {/* Centered Large Vector Icon */}
              <div className="w-14 h-14 rounded-2xl bg-themeBg/80 border border-themeBorder/80 flex items-center justify-center p-2.5 shadow-inner group-hover:border-themeAccent/40 transition-colors z-10">
                {skill.icon}
              </div>

              {/* Skill Name & Tag */}
              <div className="z-10 w-full truncate">
                <span className="text-xs font-bold text-themeText group-hover:text-themeAccent transition-colors block truncate">
                  {skill.name}
                </span>
                <span className="text-[9px] font-mono text-themeTextMuted block mt-0.5 uppercase tracking-wider truncate">
                  {skill.tag}
                </span>
              </div>
            </div>
