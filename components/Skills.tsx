...
const skills: SkillItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6 text-[#336791] shrink-0" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.003 0C5.375 0 0 5.375 0 12.003c0 6.628 5.375 12.003 12.003 12.003 6.628 0 12.003-5.375 12.003-12.003C24.006 5.375 18.631 0 12.003 0zm4.568 18.423l-1.325.438a7.844 7.844 0 0 1-3.244.478 7.397 7.397 0 0 1-3.24-.766c-.958-.518-1.733-1.282-2.269-2.238a6.54 6.54 0 0 1-.806-3.149c0-1.892.686-3.488 2.058-4.787 1.372-1.298 3.123-1.947 5.253-1.947 1.738 0 3.23.444 4.476 1.332.61.436 1.096.967 1.458 1.593.363.626.544 1.304.544 2.034 0 .973-.284 1.83-.852 2.571-.568.741-1.353 1.295-2.355 1.662l1.642 1.25a3.738 3.738 0 0 0 1.28.618l-2.62 1.911z" />
      </svg>
    )
  },
  {
    ...
    category: "backend",
    color: "#5a67d8",
    glow: "rgba(90, 103, 216, 0.25)",
    icon: (
      <svg className="w-6 h-6 text-[#5a67d8] shrink-0" viewBox="0 0 24 24" fill="currentColor">
        <path d="M20.218 19.822L13.15 2.585a1.27 1.27 0 0 0-2.3 0L3.782 19.822a1.27 1.27 0 0 0 1.656 1.656l6.562-2.684 6.562 2.684a1.27 1.27 0 0 0 1.656-1.656zM12 16.924L6.155 19.314 12 5.048l5.845 14.266L12 16.924z" />
      </svg>
    )
  },
  {
