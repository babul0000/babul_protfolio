...
export default function Footer() {
  ...
  return (
    <footer className="bg-themeBg border-t border-themeBorder py-12 text-themeText font-sans antialiased transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Brand */}
          <div className="flex flex-col items-center md:items-start gap-1">
            <span className="text-sm font-bold text-themeText tracking-wide">
              <span className="gradient-text">B</span>abul Hossan
            </span>
            <span className="text-xs text-themeTextMuted font-normal">Full Stack MERN Developer</span>
          </div>
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              <a
                key={link.label}
                href={link.href}
                className="text-xs font-semibold uppercase tracking-wider text-themeTextMuted hover:text-themeAccent transition-colors"
              >
                {link.label}
              </a>
            ))}
        ...
        <div className="h-px bg-themeBorder my-8" />
